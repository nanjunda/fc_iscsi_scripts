...
# insert the chart into the worksheet
	...
	print("Insert chart into worksheet")
...
dictarray = [
             ...
             {'categories': '=Averages!$B$7:$B$18', 'values': '=Averages!$D$7:$D$18', 'name': '=Averages!$D$6', 
              ...
              'marker' : {'type' : 'circle'},'y2_axis' : 1,}
             ]
y_axis_name.append('IOPS')
y_axis_name.append('Throughput')
chart = add_line_chart(workbook, ws, dictarray, x_axis_name, y_axis_name, 'C1', 'IO Size vs IOPS & Throughput')
y_axis_name.pop()
...
chart = add_line_chart(workbook, ws, dictarray, x_axis_name, y_axis_name, 'C16', 'IO Size vs IOPS & Latency')
y_axis_name.pop()
...
y_axis_name.append('Throughput')
y_axis_name.append('Latency')
chart = add_line_chart(workbook, ws, dictarray, x_axis_name, y_axis_name, 'C31', 'IO Size vs Throughput & Latency')
y_axis_name.pop()
...
chart = add_line_chart(workbook, ws, dictarray, x_axis_name, y_axis_name, 'C46', 'IO Size vs Throughput & CPU Utilization')
y_axis_name.pop()
