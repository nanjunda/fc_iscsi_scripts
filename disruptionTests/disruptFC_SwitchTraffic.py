...
#
# this script used python based "expect" api to reboot the switch
# based on pexpect to issue fastboot command to the switch and uses
# expect to send appropriate response to reboot the switch
#
