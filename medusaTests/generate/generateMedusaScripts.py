...
def generate_command_line(q, r, w, b):
    ...
    rm_dot_maim_file = "rm -rf /tmp/.maim_test_running"
    cl = [out_files[0], cmdL, rm_dot_maim_file, out_files[2], out_files[3], out_files[4], out_files[5]]
    return (cl)
    ...
    for qd in qdepth_list:
        for rd in rd_list:
            for bs in buffer_size_list:
                ...
                """
                print("logman_start")
                print("echo >/tmp/.maim_test_start")
                print("echo >/tmp/.maim_test_running")
                """
                logman started
                """
