...
# note: I think I have deleted the file iSCSI_FC_csvFileList.csv which contains the necessary info. the file name itself has
# the necessary info such as tech, phase (normal or congestion, congeston with disruption). No need for this script
# Will move it to notUsed
#
import csv
import os
